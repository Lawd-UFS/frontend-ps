...
function count(){
    ...
    document.getElementById("hours").textContent = hoursT < 10 ? `0${hoursT}` : hoursT;
    document.getElementById("minutes").textContent = minutesT < 10 ? `0${minutesT}` : minutesT;
    document.getElementById("seconds").textContent = secondsT < 10 ? `0${secondsT}` : secondsT;
